...
storingProfilePicture()async{
    ...
    if(this.profileData == null && this.users == null){
    ...
    else if(this.profileData == null &&  abc == null ){
      googlePic = this.users.photoURL!;
      googleName = this.users.displayName;
    }
    else if(this.users == null && abc == null){
      ...
      if(googlePic == null && faceBookpic == null){
        print(mailPic);
        print(134);
        picStore = mailPic;
        nameStore = mailName;
      }
      else if (googlePic == null && abc == null){
        picStore = faceBookpic;
        nameStore = faceBookName;
      }
      else if(abc== null && faceBookpic == null){
        picStore = googlePic;
    ...
    List<String> stringList = [picStore, nameStore];
    storing.setStringList('pic', stringList);

  }
  _apiFace() async {
    final String url = "http://baf42984f453.ngrok.io/exists/facebook";
  ...
  _api1() async {
    final String url = "http://baf42984f453.ngrok.io/exists/google";
    final response =
  ...
  Future loginUser(String email, String pass) async {
    String url = 'http://baf42984f453.ngrok.io/user_login';
    final response =
                      ...
                      FlatButton(
                        onPressed: () {
                          ...
                          Navigator.pushReplacement(
                              context,
                              new MaterialPageRoute(
                                  builder: (BuildContext context) => new Register1(empty: empty1)));
                        },
                        child: Text(
                          "Register here",
