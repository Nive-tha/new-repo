...
class _MailState extends State<Mail> {
  ...
  void initiateFacebookLogin() async {
    ...
    Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                Register(faceBookReceived: this.profileData)));
  }

  _apiFace() async {
    final String url = "http://8b8b2bbe168b.ngrok.io/exists/facebook";
  ...
  _api1() async {
    final String url = "http://8b8b2bbe168b.ngrok.io/exists/google";
    final response =
  ...
  Future loginUser(String email, String pass) async {
    String url = 'http://8b8b2bbe168b.ngrok.io/user_login';
    final response =
