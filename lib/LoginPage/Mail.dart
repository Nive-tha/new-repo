...
class _MailState extends State<Mail> {
  ...
  void initiateFacebookLogin() async {
    ...
    Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) =>
                Register1(faceBookReceived: this.profileData)));
  }

  _apiFace() async {
    final String url = "http://ee2a3fd63a82.ngrok.io/exists/facebook";
  ...
  _api1() async {
    final String url = "http://ee2a3fd63a82.ngrok.io/exists/google";
    final response =
    ...
    // Navigator.push(
    //     context, MaterialPageRoute(builder: (context) => MyHomePage(googleLanding: this.users)));
  }
  ...
  func(abc) async {
    ...
    sendingSharedPreference();
  }
  sendingSharedPreference() {
    var facebookInformation = this.profileData;
    var googleInformation = this.users;
    var normalUsername = abc;
    print(facebookInformation);
    print(googleInformation);
    print(normalUsername);
  ...
  Future loginUser(String email, String pass) async {
    String url = 'http://ee2a3fd63a82.ngrok.io/user_login';
    final response =
...
// ElevatedButton(onPressed: verifyOTP, child: Text('verifyOTP'));
    ...
    MaterialPageRoute(
    builder: (context) =>
    Register1(googleReceived: this.users)));
                      ...
                      FlatButton(
                        onPressed: () {
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => Register1(empty: empty1)));
                        },
                        child: Text(
                          "Register here",
