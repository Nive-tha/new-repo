...
storingProfilePicture()async{
  ...
  _apiFace() async {
    final String url = "http://f85a053bb7c1.ngrok.io/exists/facebook";
  ...
  _api1() async {
    final String url = "http://f85a053bb7c1.ngrok.io/exists/google";
    final response =
    ...
    if (response.statusCode == extractedDetail) {
      ...
      Navigator.pushReplacement(
          context,
          new MaterialPageRoute(
              builder: (BuildContext context) => new Register1(googleReceived: this.users)));
  ...
  Future loginUser(String email, String pass) async {
    String url = 'http://f85a053bb7c1.ngrok.io/user_login';
    final response =
