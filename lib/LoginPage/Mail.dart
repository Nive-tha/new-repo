...
class _MailState extends State<Mail> {
  ...
  _apiFace() async {
    final String url = "http://79b6b1e865a4.ngrok.io/exists/facebook";
  ...
  _api1() async {
    final String url = "http://79b6b1e865a4.ngrok.io/exists/google";
    final response =
    ...
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => Register1(googleReceived: this.users)));
    ...
    //           builder: (context) => MyHomePage(googleLanding: this.users)));
    // }
  ...
  Future loginUser(String email, String pass) async {
    String url = 'http://79b6b1e865a4.ngrok.io/user_login';
    final response =
