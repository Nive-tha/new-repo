...
class _RegisterState extends State<Register> {
  ...
  Future _save(a) async {
    ...
    print(v);
    final String url = "http://3406e34d4654.ngrok.io/user";
  ...
  Future _read(a, b, c, d, ef, gh, i, j) async {
    final String url = "http://3406e34d4654.ngrok.io/register";
...
print("hello google");
  g.text = widget.googleReceived.uid;
  ...
  print(widget.faceBookReceived);
  fa.text = widget.faceBookReceived['id'];
